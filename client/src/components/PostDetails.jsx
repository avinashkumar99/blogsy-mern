  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <div className="w-full min-h-[100vh] p-4 my-4 relative flex justify-start items-center">
            <div className="absolute md:left-14  md:ms-6 w-[60%] md:mr-2 bg-white shadow-lg rounded-lg p-6 my-8">
            ...
            <div className="fixed right-8 w-[30%] top-8 h-auto rounded-lg shadow-lg p-4">
              <div className="relative w-full h-full">
                ...
                <div className="flex flex-wrap my-8 p-4">
                  <span className="w-20 h-20 border border-pink-700 p-1 mr-4">
                    <img src={`${profileImg}`} className="w-20 object-cover" />
                  </span>
